...
public class PracticeAdapter extends RecyclerView.Adapter<PracticeAdapter.ViewHolder> {
    ...
    private void setThumbnail(String courseType, Thumbnail thumbnail, ImageView imageView) {
        if (courseType.equals(mContext.getString(R.string.freadom))) {
            ...
            Picasso.with(mContext).load(R.drawable.logo_freadom).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).into(imageView);
        } else if (courseType.equals(mContext.getString(R.string.lightsail))) {
            Picasso.with(mContext).load(R.drawable.logo_lightsail).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).into(imageView);
        } else if (courseType.equals(mContext.getString(R.string.mindspark))) {
            Picasso.with(mContext).load(R.drawable.background_thumb_mind_spark).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).fit().centerCrop().into(imageView);
        } else if (courseType.equals(mContext.getString(R.string.labelWorksheet).toLowerCase())) {
            if (thumbnail != null && !TextUtils.isEmpty(thumbnail.getThumbXL())) {
                Picasso.with(mContext).load(thumbnail.getThumbXL()).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).into(imageView);
            } else if (thumbnail != null && !TextUtils.isEmpty(thumbnail.getThumb())) {
                Picasso.with(mContext).load(thumbnail.getThumb()).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).into(imageView);
            } else if (thumbnail != null && !TextUtils.isEmpty(thumbnail.getUrl())) {
                Picasso.with(mContext).load(thumbnail.getUrl()).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).into(imageView);
            } else {
                Picasso.with(mContext).load(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).into(imageView);
            }
        } else if (thumbnail != null && !TextUtils.isEmpty(thumbnail.getThumb())) {
            Picasso.with(mContext).load(thumbnail.getThumb()).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).fit().centerCrop().into(imageView);
        } else if (thumbnail != null && !TextUtils.isEmpty(thumbnail.getThumbXL())) {
            Picasso.with(mContext).load(thumbnail.getThumbXL()).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).fit().centerCrop().into(imageView);
        } else if (thumbnail != null && !TextUtils.isEmpty(thumbnail.getUrl())) {
            Picasso.with(mContext).load(thumbnail.getUrl()).placeholder(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).fit().centerCrop().into(imageView);
        } else {
            Picasso.with(mContext).load(R.drawable.image_placeholder_curved).transform(new RoundedCornersTransformation(36, 0, RoundedCornersTransformation.CornerType.ALL)).fit().centerCrop().into(imageView);
        }

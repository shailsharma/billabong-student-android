 ...
 */
public class DownloadAboutCoursePopUpsJsonJob extends BaseDownloadJobWeb<AboutCourse> {
     ...
     */
    public DownloadAboutCoursePopUpsJsonJob(String objectId) {
        super(objectId, "");
    ...
    public DownloadAboutCoursePopUpsJsonJob(String objectId, String notificationId) {
    ...
    public DownloadAboutCoursePopUpsJsonJob(String objectId, String notificationId, boolean isBroadcast) {
        super(objectId, notificationId);

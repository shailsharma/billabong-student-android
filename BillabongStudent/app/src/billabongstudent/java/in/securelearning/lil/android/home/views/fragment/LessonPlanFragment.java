...
//        if ((mSubjectId.equals("58c92576bddb93e4048f6124") || (mSubjects != null && mSubjects.contains("58c92576bddb93e4048f6124")))) {
//            ArrayList<String> list = new ArrayList<>();
//            list.add("5a7d13eb39682c120058b73a");
//            list.add("5a7fcfa439682c12005932a0");
//            list.add("5a7fd23e39682c12005932b9");
//            list.add("5a7fd2a639682c12005932ea");
//            list.add("5a7fd35939682c120059331b");
//            getPrerequisiteCourses(list, 0, 10);

//            AboutCourseExt aboutCourseExt1 = new AboutCourseExt();
//            aboutCourseExt1.setObjectId("59dcc97e84111b1a00fad795");
//            aboutCourseExt1.setTitle("The Cell");
//            aboutCourseExt1.setName("digitalbook");
//            aboutCourseExt1.getMetaInformation().getTopic().setName("Living things");
//            aboutCourseExt1.setThumbnailUrl("https://res.cloudinary.com/learnindialearn/image/upload/v1507641697/kaxj0onij6k4wbvgns7q.jpg");
...
//            aboutCourseExt5.getMetaInformation().getTopic().setName("Living things");
...
//            aboutCourseExt6.getMetaInformation().getTopic().setName("Living things");
...
//        }
    ...
    class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final CourseAdapter.ViewHolder holder, final int position) {
            ...
            holder.mBinding.imageViewThumbnail.setVisibility(View.GONE);

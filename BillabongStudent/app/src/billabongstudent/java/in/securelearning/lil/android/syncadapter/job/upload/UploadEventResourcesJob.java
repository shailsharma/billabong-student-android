...
/**
 * Job to upload CalendarEvent resources.
 */
public abstract class UploadEventResourcesJob extends BaseUploadJob<CalendarEvent> {
    /**
     * handles initialization of injector component
     * and initializes the object to upload
     *
     * @param calendarEvent object to upload
     */
    public UploadEventResourcesJob(CalendarEvent calendarEvent) {
        super(calendarEvent);
    ...
    public void execute() {
        try {
            /*post resources and update the CalendarEvent*/
            if (uploadResourcesAndUpdateCalenarData()) {
     ...
     * @throws IOException
     */
    public boolean uploadResourcesAndUpdateCalenarData() throws IOException {
        boolean success = false;

               /*count of resources to upload*/
        int countToUpload = getListOfAllResourcesToUpload(mDataObject.getAttachments());
        ...
        for (Resource resourceLocal : mDataObject.getAttachments()) {
...
//                    Resource resourceNetwork = response.body().getResource();
                        ...
                        //mDataObject.getAttachments().add(resourceLocal);
                        ...
                        Log.e("err Cal Event Res Upl", response.message());
                    }
                }
            }
        }
...
//    }
     ...
     * @return count
     */
    public int getNumberOfResourcesToUpload(List<Resource> resourseList) {
        /*count of resources to upload*/
        int count = 0;

...
import in.securelearning.lil.android.analytics.adapter.StudentCoverageAdapter;
...
public class StudentCoverageFragment extends Fragment {
    ...
    public static Fragment newInstance(ArrayList<ChartConfigurationData> coverageConfiguration) {
        ...
        args.putSerializable(StudentConstantUtil.COVERAGE, (Serializable) coverageConfiguration);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null && getArguments().getSerializable(StudentConstantUtil.COVERAGE) != null) {

            this.mChartConfigurationData = (ArrayList<ChartConfigurationData>) getArguments().getSerializable(StudentConstantUtil.COVERAGE);
        }
    }
    ...
    private void drawCoverageChart(ArrayList<ChartConfigurationData> coverageConfiguration, ArrayList<CoverageChartData> coverageChartData) {
        ...
        for (int i = 0; i < coverageChartData.size(); i++) {
            ...
            float coverage = Math.round(data.getCoverage());
        ...
        mBinding.chartCoverage.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                float coverage = Math.round(ccd.getCoverage());
                ...
                mBinding.textViewPerformanceCount.setText(String.format("%s %%", String.valueOf(coverage)));
            }
    ...
    public int pickColorAccording(float coverage) {

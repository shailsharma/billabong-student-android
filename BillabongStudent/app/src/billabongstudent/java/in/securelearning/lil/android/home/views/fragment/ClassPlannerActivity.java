...
import in.securelearning.lil.android.app.databinding.LayoutActivityClassPlannerSampleBinding;
...
public class ClassPlannerActivity extends AppCompatActivity {
    ...
    LayoutActivityClassPlannerSampleBinding mBinding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.layout_activity_class_planner_sample);
        setUpToolbar();
        setUpViewPager();
    }
    ...
    private void setUpToolbar() {
        ...
        setTitle("Today, " + DateUtils.getFormatedDateFromDate(new Date()));
    ...
    private class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        private String[] mTabTitles = new String[]{"X A Bio", "X B Bio", "X C Bio"};

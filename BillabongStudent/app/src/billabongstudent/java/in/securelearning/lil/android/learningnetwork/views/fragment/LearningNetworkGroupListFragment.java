...
import in.securelearning.lil.android.app.databinding.LayoutItemLearningNetworkGroupBinding;
...
import in.securelearning.lil.android.syncadapter.utils.TimeUtils;
...
public class LearningNetworkGroupListFragment extends Fragment {
                    ...
                    public void accept(final Object event) throws Exception {
                        if (event instanceof LoadNewPostCreatedEvent) {
                            ...
                            Completable.complete()
                                ...
                                && ((ObjectDownloadComplete) event).getObjectClass().equals(Group.class)) {
                            Completable.complete()
                                    .observeOn(AndroidSchedulers.mainThread())
                                    .subscribe(new Action() {
                                        @Override
    ...
    private class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.ViewHolder> {
        ...
        public GroupAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutItemLearningNetworkGroupBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.layout_item_learning_network_group, parent, false);
        ...
        public void onBindViewHolder(final GroupAdapter.ViewHolder holder, final int position) {
            ...
            CommonUtils.getInstance().setGroupThumbnail(getContext(), name, group.getThumbnail(), holder.mBinding.imageViewGroupThumbnail);
        ...
        private void setLatestPost(final Group group, final LayoutItemLearningNetworkGroupBinding binding) {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            LayoutItemLearningNetworkGroupBinding mBinding;

            public ViewHolder(LayoutItemLearningNetworkGroupBinding binding) {

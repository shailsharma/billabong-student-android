...
import in.securelearning.lil.android.analytics.adapter.StudentPerformanceAdapter;
...
public class StudentPerformanceFragment extends Fragment implements View.OnClickListener {
    ...
    public static Fragment newInstance(ChartConfigurationParentData.BenchMarkPerformance benchMarkPerformance) {
        ...
        args.putSerializable(StudentConstantUtil.BENCHMARK_PERFORMANCE, (Serializable) benchMarkPerformance);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mBenchMarkPerformance = (ChartConfigurationParentData.BenchMarkPerformance) getArguments().getSerializable(StudentConstantUtil.BENCHMARK_PERFORMANCE);
        }
    }

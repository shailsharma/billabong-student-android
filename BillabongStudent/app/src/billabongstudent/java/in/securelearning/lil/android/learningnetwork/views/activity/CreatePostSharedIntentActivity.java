            ...
            holder.mResourceImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (mimeType.contains("image")) {
                        ...
                        mContext.startActivity(PlayVideoFullScreenActivity.getStartActivityIntent(mContext, ConstantUtil.BLANK, ConstantUtil.BLANK, PlayVideoFullScreenActivity.NETWORK_TYPE_LOCAL, (Resource) item));
                    }

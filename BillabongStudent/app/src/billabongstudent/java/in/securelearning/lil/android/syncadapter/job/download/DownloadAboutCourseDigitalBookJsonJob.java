 ...
 */
public class DownloadAboutCourseDigitalBookJsonJob extends BaseDownloadJobWeb<AboutCourse> {
     ...
     */
    public DownloadAboutCourseDigitalBookJsonJob(String objectId) {
        super(objectId, "");
    ...
    public DownloadAboutCourseDigitalBookJsonJob(String objectId, String notificationId) {
    ...
    public DownloadAboutCourseDigitalBookJsonJob(String objectId, String notificationId, boolean isBroadcast, boolean shouldCreateUserNotification) {
        super(objectId, notificationId);
...
//here we are making clone of notification, and saving it in local database, for showing result in Notification tab at home screen

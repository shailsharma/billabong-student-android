 ...
 */
public class DownloadAboutCourseInteractiveVideoJsonJob extends BaseDownloadJobWeb<AboutCourse> {
     ...
     */
    public DownloadAboutCourseInteractiveVideoJsonJob(String objectId) {
        super(objectId, "");
    ...
    public DownloadAboutCourseInteractiveVideoJsonJob(String objectId, String notificationId) {
    ...
    public DownloadAboutCourseInteractiveVideoJsonJob(String objectId, String notificationId, boolean isBroadcast) {
        super(objectId, notificationId);

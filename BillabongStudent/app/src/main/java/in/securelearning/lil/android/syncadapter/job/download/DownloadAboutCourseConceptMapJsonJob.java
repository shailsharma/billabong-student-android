 ...
 */
public class DownloadAboutCourseConceptMapJsonJob extends BaseDownloadJobWeb<AboutCourse> {
     ...
     */
    public DownloadAboutCourseConceptMapJsonJob(String objectId) {
        super(objectId, "");
    ...
    public DownloadAboutCourseConceptMapJsonJob(String objectId, String notificationId) {
    ...
    public DownloadAboutCourseConceptMapJsonJob(String objectId, String notificationId, boolean isBroadcast) {
        super(objectId, notificationId);

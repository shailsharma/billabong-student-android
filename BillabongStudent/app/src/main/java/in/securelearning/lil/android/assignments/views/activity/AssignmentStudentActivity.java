...
import in.securelearning.lil.android.app.databinding.ActivityAssignmentStudentBinding;
...
public class AssignmentStudentActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, FilterFragment.OnFilterFragmentInteractionListener {
    ActivityAssignmentStudentBinding mBinding;
    private MenuItem menuItemSearch, menuItemFilter, menuItemBrowse, menuItemBookmark, menuItemDone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.string_assignments));
    ...
    private void setUpFragment() {
        if (getIntent() != null && getIntent().getExtras() != null) {
            ...
            final AssignmentStudentFragment fragment = AssignmentStudentFragment.newInstance(assignmentDate);
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.container_assignment_student, fragment);
            ...
            final AssignmentStudentFragment fragment = new AssignmentStudentFragment();
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.container_assignment_student, fragment);
            fragmentTransaction.commit();
    ...
    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, AssignmentStudentActivity.class);
        return intent;
    }
        ...
        if (id == R.id.action_browse) {
            ...
            Observable.create(new ObservableOnSubscribe<FilterList>() {
                ...
                public void subscribe(ObservableEmitter<FilterList> e) throws Exception {
                    if (mSubjects == null) {
                        mSubjects = PrefManager.getSubjectNames(AssignmentStudentActivity.this);
                    }
            ...
            if (getIntent() != null && getIntent().getExtras() != null && !TextUtils.isEmpty(getIntent().getExtras().getString("date"))) {
                String assignmentDate = getIntent().getExtras().getString("date");
                startActivity(AssignmentCompletedStudentActivity.getStartIntentForCalendar(getBaseContext(), assignmentDate));
    ...
    private FilterList buildFilter(int filterType) {
        ...
        if (filterType == FILTER_TYPE_ASSIGNMENT) {

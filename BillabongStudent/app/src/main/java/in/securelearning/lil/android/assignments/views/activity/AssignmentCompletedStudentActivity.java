...
public class AssignmentCompletedStudentActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, FilterFragment.OnFilterFragmentInteractionListener {
    private ActivityAssignmentStudentBinding mBinding;
    ...
    private void setUpFragment() {
        if (getIntent() != null && getIntent().getExtras() != null) {
            ...
            final AssignmentCompletedStudentFragment fragment = AssignmentCompletedStudentFragment.newInstance(assignmentDate);
            ...
            final AssignmentCompletedStudentFragment fragment = new AssignmentCompletedStudentFragment();
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.container_assignment_student, fragment);
            fragmentTransaction.commit();
    ...
    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, AssignmentCompletedStudentActivity.class);
        return intent;
    }
        ...
        if (id == R.id.action_browse) {
            ...
            Observable.create(new ObservableOnSubscribe<FilterList>() {
                ...
                public void subscribe(ObservableEmitter<FilterList> e) throws Exception {
                    if (mSubjects == null) {
                        mSubjects = PrefManager.getSubjectNames(AssignmentCompletedStudentActivity.this);
                    }

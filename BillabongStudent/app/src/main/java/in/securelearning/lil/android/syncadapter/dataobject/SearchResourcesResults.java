...
public class SearchResourcesResults {

    @SerializedName("results")
    @Expose
    ArrayList<FavouriteResource> mList = new ArrayList<>();
...
//    ArrayList<SearchFilterId> mLearningLevelList = new ArrayList<>();
    ...
    public ArrayList<FavouriteResource> getList() {
        return mList;
    }

    public void setList(ArrayList<FavouriteResource> list) {
        mList = list;
    }

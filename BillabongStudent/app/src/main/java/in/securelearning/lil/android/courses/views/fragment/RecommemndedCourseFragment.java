...
public class RecommemndedCourseFragment extends Fragment {
    ...
    public RecommemndedCourseFragment() {
    }


    public static RecommemndedCourseFragment newInstance(int columnCount) {
        RecommemndedCourseFragment fragment = new RecommemndedCourseFragment();
    ...
    class ResourcePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            CourseListFragment fragment = CourseListFragment.newInstanceForTopicBrowse(mSubjectId, "", "", mColumnCount);
            return fragment;
        }

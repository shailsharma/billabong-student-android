...
public class RecommendedCourseFragment2 extends Fragment {
    @Inject
    ...
    public RecommendedCourseFragment2() {
    }


    public static RecommendedCourseFragment2 newInstance(int columnCount) {
        RecommendedCourseFragment2 fragment = new RecommendedCourseFragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<CuratorMapping> classList = mCuratorMappingModel.getCompleteList();
...
//        }
    ...
    class ResourcePagerAdapter extends FragmentStatePagerAdapter {
        Context mContext;
        ArrayList<SubjectExt> subjectList;
        ...
        public Fragment getItem(int position) {
            ...
            if (subjectList.get(position).getSubjects() != null && subjectList.get(position).getSubjects().size() > 0) {
                for (SubjectSuper subjectSuper : subjectList.get(position).getSubjects()) {
            ...
            CourseListFragment fragment = CourseListFragment.newInstanceForTopicBrowseCourses(mSubjectId, "", gradeId, mColumnCount);
            return fragment;

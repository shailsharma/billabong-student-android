...
public class AssignmentCompletedTeacherActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, FilterFragment.OnFilterFragmentInteractionListener {
    ...
    private void setUpFragment() {
        if (getIntent() != null && getIntent().getExtras() != null) {
            ...
            final AssignmentCompletedTeacherFragment fragment = AssignmentCompletedTeacherFragment.newInstance(assignmentDate);
            ...
            final AssignmentCompletedTeacherFragment fragment = new AssignmentCompletedTeacherFragment();
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.container_assignment_teacher, fragment);
            fragmentTransaction.commit();
    ...
    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, AssignmentCompletedTeacherActivity.class);
        return intent;
    }
        ...
        if (id == R.id.action_browse) {
            ...
            Observable.create(new ObservableOnSubscribe<FilterList>() {
                ...
                public void subscribe(ObservableEmitter<FilterList> e) throws Exception {
                    if (mSubjects == null) {
                        mSubjects = PrefManager.getSubjectNames(AssignmentCompletedTeacherActivity.this);
                    }

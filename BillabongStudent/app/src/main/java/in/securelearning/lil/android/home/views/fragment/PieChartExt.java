...
public class PieChartExt extends PieRadarChartBase<PieDataExt> {
    ...
    public PieChartExt(Context context) {
        super(context);
    }

    public PieChartExt(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PieChartExt(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new PieChartRendererExt(this, mAnimator, mViewPortHandler);
        mXAxis = null;
    }

...
public class AssignmentCompletedTrainerActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, FilterFragment.OnFilterFragmentInteractionListener {
    ...
    private void setUpFragment() {
        if (getIntent() != null && getIntent().getExtras() != null) {
            ...
            final AssignmentCompletedTrainerFragment fragment = AssignmentCompletedTrainerFragment.newInstance(groupId);
            ...
            final AssignmentCompletedTrainerFragment fragment = new AssignmentCompletedTrainerFragment();
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.container_assignment_teacher, fragment);
            fragmentTransaction.commit();
    ...
    public static Intent getStartIntent(Context context, String groupId) {
        Intent intent = new Intent(context, AssignmentCompletedTrainerActivity.class);
        ...
        if (id == R.id.action_browse) {
            ...
            Observable.create(new ObservableOnSubscribe<FilterList>() {
                ...
                public void subscribe(ObservableEmitter<FilterList> e) throws Exception {
                    if (mSubjects == null) {
                        mSubjects = PrefManager.getSubjectNames(AssignmentCompletedTrainerActivity.this);
                    }

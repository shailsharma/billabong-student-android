...
/**
 * Created by Chaitendra on 27-Jan-18.
 */

public class AssignmentCompletedTraineeActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, FilterFragment.OnFilterFragmentInteractionListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.string_submitted));
    ...
    private void handleIntent() {
        if (getIntent() != null && getIntent().getExtras() != null) {
            String groupId = getIntent().getExtras().getString(TRAINING_GROUP_ID);
            final AssignmentCompletedTraineeFragment fragment = AssignmentCompletedTraineeFragment.newInstance(groupId);
            ...
            final AssignmentCompletedTraineeFragment fragment = new AssignmentCompletedTraineeFragment();
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.container_assignment_teacher, fragment);
            fragmentTransaction.commit();
    ...
    public static Intent getStartIntent(Context context, String groupId) {
        Intent intent = new Intent(context, AssignmentCompletedTraineeActivity.class);
        ...
        if (id == R.id.action_browse) {
            ...
            Observable.create(new ObservableOnSubscribe<FilterList>() {
                ...
                public void subscribe(ObservableEmitter<FilterList> e) throws Exception {
                    if (mSubjects == null) {
                        mSubjects = PrefManager.getSubjectNames(AssignmentCompletedTraineeActivity.this);
                    }

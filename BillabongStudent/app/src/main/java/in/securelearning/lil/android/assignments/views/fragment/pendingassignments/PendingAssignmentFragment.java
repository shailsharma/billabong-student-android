...
public class PendingAssignmentFragment extends Fragment implements AssignmentView {
    ...
    public PendingAssignmentFragment() {
        // Required empty public constructor
    }

    public static PendingAssignmentFragment newInstance(SlidingTabLayout mSlidingTabLayout) {
        PendingAssignmentFragment pendingAssignmentFragment = new PendingAssignmentFragment();
        slidingTabLayout = mSlidingTabLayout;
        return pendingAssignmentFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPendingAssignmentPresenter = new PendingAssignmentPresenterImpl(this);
    ...
    private void getData() {
        mPendingAssignmentPresenter.getAssignmentsList();
    }
...
//                Picasso.with(getContext()).load(assignmentResponse.getThumbnail().getLocalUrl()).placeholder(R.drawable.gradient_black_bottom).resize(600, 440).centerInside().into(assignmentThumbnailImageView);
//            } else if (assignmentResponse.getThumbnail() != null && assignmentResponse.getThumbnail().getUrl() != null && !assignmentResponse.getThumbnail().getUrl().isEmpty()) {
//                Picasso.with(getContext()).load(assignmentResponse.getThumbnail().getUrl()).placeholder(R.drawable.gradient_black_bottom).resize(600, 440).centerInside().into(assignmentThumbnailImageView);
//            } else if (assignmentResponse.getThumbnail() != null && assignmentResponse.getThumbnail().getThumb() != null && !assignmentResponse.getThumbnail().getThumb().isEmpty()) {
//                Picasso.with(getContext()).load(assignmentResponse.getThumbnail().getThumb()).placeholder(R.drawable.gradient_black_bottom).resize(600, 440).centerInside().into(assignmentThumbnailImageView);
//            } else {
//                Picasso.with(getContext()).load(R.drawable.image_quiz_default).resize(600, 440).centerInside().into(assignmentThumbnailImageView);
//            }
...
//                Picasso.with(getContext()).load(assignmentResponse.getThumbnail().getThumb()).placeholder(R.drawable.gradient_black_bottom).resize(600, 440).centerInside().into(assignmentThumbnailImageView);
//            } catch (Exception e) {
//                if (assignmentResponse.getThumbnail() != null && assignmentResponse.getThumbnail().getThumb() != null && !assignmentResponse.getThumbnail().getThumb().isEmpty()) {
//                    Picasso.with(getContext()).load(assignmentResponse.getThumbnail().getThumb()).placeholder(R.drawable.gradient_black_bottom).resize(600, 440).centerInside().into(assignmentThumbnailImageView);
//                } else {
//                    Picasso.with(getContext()).load(R.drawable.image_quiz_default).resize(600, 440).centerInside().into(assignmentThumbnailImageView);
//                }
